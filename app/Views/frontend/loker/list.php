...
<main class="main" id="post-product" style="margin-top: 16vh">
    <div class="container">
        <div class="title d-flex align-items-center">
            ...
            <p class="fw-600 ml-4" style="font-size:36px;">Lowonganku</p>
        </div>
        ...
        <?php if (count($loker) == 0) { ?>
            <h3>Anda belum memiliki lowongan</h3>
        <?php } ?>
        <div>
            <?php foreach ($loker as $data) { ?>
                <div class="card w-100 my-3">
                    <div class="card-body d-flex">
                        <div>
                            <img src="<?= base_url() ?>/uploads/<?= $data['image'] ?>" alt="<?= $data['posisi'] ?>" style="width: 150px; height:150px;">
                        </div>
                        <div class="decs-product ml-3" style="line-height: 10px;">
                            <div class="d-flex justify-content-between">
                                ...
                                <div style="flex: 1;">
                                    <div class="d-flex">
                                        ...
                                        <a href="<?= base_url('loker/form') ?>/<?= $data['id'] ?>" class="btn btn-primary btn-sm ml-2">
                            ...
                            <p class="color-price fs-16"> <?= $data['tipe'] ?> - <?= $convert->ribuan($data['gaji']) ?>,-</p>
